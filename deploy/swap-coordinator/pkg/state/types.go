...
type WorkerMetadata struct {
	// InstanceID is the unique identifier for the worker instance
	InstanceID string
...
func (s *SwapGroupInstanceState) AddWorker(instanceID string) {
...
func (s *SwapGroupInstanceState) RemoveWorker(instanceID string) {
